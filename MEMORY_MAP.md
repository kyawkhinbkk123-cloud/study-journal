...
═══════════════════════════════════════════════════════════════
  ဘယ်ဟာ ဘယ်မှာ — routing (fact တစ်ခု = နေရာတစ်ခု)
═══════════════════════════════════════════════════════════════
  ...
  ၆ လ stable rule .......... memory tool (T0)
...
═══════════════════════════════════════════════════════════════
  ...
  ⚠️ RAG/embed box (ပုံထဲက) = မထည့် — quota စား + failure အသစ်
  ⚠️ providers: .env only ← config.yaml နဲ့ မရော

═══════════════════════════════════════════════════════════════
  access pattern (ဘာလို့ store ခွဲလဲ — ဝါးစည်း အနှစ်သာရ)
═══════════════════════════════════════════════════════════════
  store တစ်ခု = ကြည့်ပုံ တစ်မျိုး = ဖြုတ်လို့ရ

  PITFALLS.md ...... symptom နဲ့ SEARCH ... code မရေးခင်
  LESSONS.md ....... ဇာတ်ကြောင်း READ ..... session ပြီးမှ
  skills/ .......... workflow REUSE ....... တစ်ခုလုံး ထပ်လုပ်
